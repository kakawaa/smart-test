...
function(t, e) {
    ...
    var e = function(t) {
        ...
        A = function() {
            ...
            n._init = function() {
                ...
                t(window).scroll((function() { (t("body").hasClass(h) || t("body").hasClass(f)) && e._fixScrollHeight()
                }))
            },
            ...
            n._fixHeight = function() {
                ...
                if (t("body").hasClass(u)) {
                    var s = e - i; (t("body").hasClass(v) || t("body").hasClass(y) || t("body").hasClass(b) || t("body").hasClass(w) || t("body").hasClass(D)) && "fixed" === t(c).css("position") && (s = e - i - n),
                    t(o + " " + a).css("height", s),
    ...
    i = function(t) {
        ...
        _ = function() {
            ...
            return i.fixLayoutHeight = function() {
                ...
                t("body").hasClass(f) && (t(a).css("min-height", i - e.header - e.footer), "undefined" != typeof t.fn.overlayScrollbars && t(o).overlayScrollbars({
                    className: this._config.scrollbarTheme,
                    sizeAutoCapable: !0,
                    scrollbars: {
                        autoHide: this._config.scrollbarAutoHide,
    ...
    l = function(t) {
        ...
        r = function() {
            function e(e, i) {
                if (this._element = e, this._parent = e.parents(o.CARD).first(), this._settings = t.extend({},
                a, i), this._overlay = t(this._settings.overlayTemplate), e.hasClass(s.CARD) && (this._parent = e), "" === this._settings.source) throw new Error("Source url was not defined. Please specify a url in your CardRefresh source option.");
                this._init(),
            ...
            return i.load = function() {
                ...
                t.get(this._settings.source, this._settings.params,
                function(e) {
            ...
            e._jQueryInterface = function(i) {
                ...
                s = t.extend({},
                a, t(this).data());
                n || (n = new e(t(this), s), t(this).data("lte.cardrefresh", "string" == typeof i ? n: i)),
