...
module.exports = function (grunt) {
  ...
  Object.keys(configBridge.paths).forEach(function (key) {
    configBridge.paths[key].forEach(function (val, i, arr) {
      arr[i] = path.join('./docs/quickit', val);
    });
  });
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      assets: {
        src: ['docs/quickit/js/src/*.js', 'docs/quickit/js/*.js', '!docs/quickit/js/*.min.js']
      }
    },
    ...
    uglify: {
      ...
      customize: {
        ...
        dest: 'docs/quickit/js/customize.min.js'
      },
      docs: {
        src: configBridge.paths.docsJs,
        dest: 'docs/quickit/js/docs.min.js'
      }
    },
    ...
    less: {
      ...
      docs: {
        options: {
          ...
          sourceMapFilename: 'docs/quickit/css/docs.css.map'
        },
        src: 'docs/quickit/less/docs.less',
        dest: 'docs/quickit/css/docs.css'
      },
      docsIe: {
        options: {
          sourceMap: false
        },
        src: 'docs/quickit/less/ie10-viewport-bug-workaround.less',
        dest: 'docs/quickit/css/ie10-viewport-bug-workaround.css'
      }
    },
    ...
    cssmin: {
      ...
      docs: {
        src: 'docs/quickit/css/docs.css',
        dest: 'docs/quickit/css/docs.min.css'
      }
    },
  ...
  grunt.registerTask('lint-docs-js', ['jshint:quickit', 'jscs:quickit']);
