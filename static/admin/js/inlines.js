    ...
    $.fn.formset = function(opts) {
        ...
        const addInlineAddButton = function() {
            if (addButton === null) {
                if ($this.prop("tagName") === "TR") {
                    ...
                    $parent.append('<tr class="' + options.addCssClass + '"><td colspan="' + numCols + '"><a >' + options.addText + "</a></tr>");
                    addButton = $parent.find("tr:last a");
                } else {
                    // Otherwise, insert it immediately after the last form:
                    $this.filter(":last").after('<div class="' + options.addCssClass + '"><a >' + options.addText + "</a></div>");
        ...
        const addInlineDeleteButton = function(row) {
            if (row.is("tr")) {
                ...
                row.children(":last").append('<div><a class="' + options.deleteCssClass + '" >' + options.deleteText + "</a></div>");
                ...
                row.children(":first").append('<span><a class="' + options.deleteCssClass + '" >' + options.deleteText + "</a></span>");
            }
